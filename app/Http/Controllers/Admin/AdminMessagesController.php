...
class AdminMessagesController extends Controller
{
    public function UnreadMessages()
    {
        ...
        return view('admin.user_unread_messages', compact('messages'));
    }

    public function ReadMessages()
    {
        $messages = UserContact::where(['user_id' => Auth::user()->id, 'read' => 1])->latest()->get();
        return view('admin.user_read_messages', compact('messages'));
    }
    ...
    public function MessageDetail($id)
    {
        ...
        return view('admin.user_message_detail', compact('message', 'previous_messages'));
    }
