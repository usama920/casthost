...
class UserStoreOrdersController extends Controller
{
    ...
    public function OrderDetail($id)
    {
        ...
        return view('dashboard.store_order_detail', compact('order'));
    }
