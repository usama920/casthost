...
class UserDashboardPodcastsExport implements WithHeadings, FromQuery, WithMapping
{
    /**
    ...
    */
    ...
    {
        $podcasts = Podcast::where(['user_id' => Auth::user()->id])->withCount(['user', 'category', 'views', 'downloads', 'lastDayViews', 'lastSevenDayViews','lastThirtyDayViews', 'lastDayDownloads', 'lastSevenDayDownloads', 'lastThirtyDayDownloads']);
        return $podcasts;
    }
