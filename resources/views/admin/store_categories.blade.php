...
@section('store_categories', 'active')
@section('content')
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Store Categories</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('/admin')}}">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{url('/admin/store/categories')}}">Store Categories</a>
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <section id="basic-horizontal-layouts">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{url('/admin/store/category/inactive/'.$category->id)}}"><span class="badge rounded-pill badge-light-primary">Active</span></a>
                                                @elseif ($category->status == 0)
                                                <a href="{{url('/admin/store/category/active/'.$category->id)}}"><span class="badge rounded-pill badge-light-secondary">Inactive</span></a>
                                                @endif
                                            </td>
                                            <td class="text-center">
                                                <button type="button" class="btn p-0" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" id="{{$category->id}}" onclick="EditCategory(this.id)">
                                                    <span class="badge rounded-pill badge-light-danger"><i data-feather="edit" class="me-50"></i>Edit</span>
                                                </button>
                                                <a href="{{url('/admin/store/category/delete/'.$category->id)}}">
                ...
                <div class="modal modal-slide-in fade" id="modals-slide-in" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog sidebar-sm">
                        <form class="add-new-record modal-content pt-0" method="POST" action="{{url('/admin/store/category/add')}}">
                            @csrf
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="add-new-record modal-content pt-0" method="POST" action="{{url('/admin/store/category/edit')}}">
                    <div class="modal-body">
                        @csrf
                        <input type="hidden" name="id" id="category_id" />
                        <div class="mb-1">
                            <label class="form-label" for="basic-icon-default-fullname">Title</label>
                            <input type="text" class="form-control dt-full-name" id="category_title" name="title" required placeholder="Title" />
                            @error('title')
                            <span style="color: red; font-weight: 500; font-size:13px">{{$message}}</span>
                            @enderror
                        </div>
