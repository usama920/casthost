                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <h2 class="fw-bolder">{{count($users)}}</h2>
                                <p class="card-text"><strong>Total Users</strong></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <h3 class="fw-bolder">{{get_memory_usage(Auth::user()->id, "admin")." / ".Auth::user()->memory_limit." GB"}}</h3>
