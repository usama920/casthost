            ...
            <section id="basic-horizontal-layouts">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{url('/admin/category/inactive/'.$category->id)}}"><span class="badge rounded-pill badge-light-primary">Active</span></a>
                                                @elseif ($category->status == 0)
                                                <a href="{{url('/admin/category/active/'.$category->id)}}"><span class="badge rounded-pill badge-light-secondary">Inactive</span></a>
                                                @endif
                                            </td>
                                            <td class="text-center">
                ...
                <div class="modal modal-slide-in fade" id="modals-slide-in" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog sidebar-sm">
                        <form class="add-new-record modal-content pt-0" method="POST" action="{{url('/admin/category/add')}}">
                            @csrf
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="add-new-record modal-content pt-0" method="POST" action="{{url('/admin/category/edit')}}">
