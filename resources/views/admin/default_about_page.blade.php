...
@section('page_title', 'Default About Page')
@section('default_about_page', 'active')
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Default About Page</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="{{ url('/admin/default/pages/about') }}">Default About Page</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <section id="multiple-column-form">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form class="form" action="{{ url('/admin/default/pages/about') }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <textarea id="editor1" name="text" rows="10" class="form-control">{{$page->text}}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <input type="submit"
