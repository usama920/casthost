                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{url('/admin/store/colors')}}">Store Colors</a>
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <section id="basic-horizontal-layouts">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if($color->status == 1)
                                                <a href="{{url('/admin/store/color/inactive/'.$color->id)}}"><span class="badge rounded-pill badge-light-primary">Active</span></a>
                                                @elseif ($color->status == 0)
                                                <a href="{{url('/admin/store/color/active/'.$color->id)}}"><span class="badge rounded-pill badge-light-secondary">Inactive</span></a>
                                                @endif
                                            </td>
                                            <td class="text-center">
                                                ...
                                                <a href="{{url('/admin/store/color/delete/'.$color->id)}}">
                ...
                <div class="modal modal-slide-in fade" id="modals-slide-in" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog sidebar-sm">
                        <form class="add-new-record modal-content pt-0" method="POST" action="{{url('/admin/store/color/add')}}">
                            @csrf
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="add-new-record modal-content pt-0" method="POST" action="{{url('/admin/store/color/edit')}}">
