                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{url('/admin/podcast/new')}}">New Podcast</a>
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if($limit >= 10)
                            <form class="form form-horizontal" method="POST" action="{{url('/admin/podcast/save')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-1 row">
    ...
    pond1.setOptions({
        ...
        server: {
            ...
            revert: (uniqueFileId, load, error) => {
                $.ajax({
                    url: '/admin/podcast/new/revert/' + uniqueFileId,
