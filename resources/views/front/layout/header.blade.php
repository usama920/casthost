...
<head>
    ...
    <!-- Web Fonts  -->
    <link id="googleFonts"
        href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700,800%7CPT+Sans:400,700&display=swap"
...
<body class="loading-overlay-showing" data-loading-overlay data-plugin-options="{'hideDelay': 500}">
    ...
    <div class="body">
        <header id="header" class="header-full-width transparent-header"
            data-plugin-options="{'stickyEnabled': true, 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': false, 'stickyStartAt': 78, 'stickySetTop': '0'}">
                        ...
                        <div class="header-column">
                            <div class="header-row">
                                <div class="header-logo">
                                    <a href="{{ url('/') }}">
                                        <img alt="Porto" width="150" height="39" style="image-rendering: auto;"
                                            src="{{ asset('project_assets/images/' . $settings->site_logo) }}">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="header-column justify-content-end">
                            <div class="header-row">
                                <div class="header-nav">
                                    <div
                                        class="header-nav-main header-nav-main-photography-effect-1 header-nav-main-sub-effect-1">
                                        <nav class="collapse">
                                            <ul class="nav nav-pills" id="mainNav">
                                                <li class="dropdown-primary">
                                                    <a class="nav-link @yield('navbar_home')" href="{{ url('/') }}">
                                                        Home
                                                    </a>
                                                </li>
                                                <li class="dropdown-primary">
                                                    <a class="nav-link @yield('navbar_about')" href="{{ url('/about') }}">
                                                        About
                                                    </a>
                                                </li>
                                                <li class="dropdown-primary">
                                                    <a class="nav-link @yield('navbar_contact')"
                                                        href="{{ url('/contact') }}">
                                                        Contact
                                                    </a>
                                                </li>
                                    ...
                                    <ul class="header-social-icons social-icons d-none d-sm-block">
                                        @if ($settings->facebook != null)
                                            <li class="social-icons-facebook"><a href="{{ $settings->facebook }}"
                                                    target="_blank" title="Facebook"><i
                                                        class="fab fa-facebook-f"></i></a></li>
                                        @endif
                                        @if ($settings->instagram != null)
                                            <li class="social-icons-instagram"><a href="{{ $settings->instagram }}"
                                                    target="_blank" title="Instagram"><i
                                                        class="fab fa-instagram"></i></a></li>
                                        @endif
                                        @if ($settings->twitter != null)
                                            <li class="social-icons-twitter"><a href="{{ $settings->twitter }}"
