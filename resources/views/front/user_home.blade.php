    ...
    <div class="container">
        <div class="row py-3">
            <div class="col-md-12 align-self-center p-static order-2 text-center">
                ...
                <a href="{{url('/unsubscribe/'.$user->id)}}" class="btn btn-outline btn-danger mb-2" >Unsubscribe</a>
                @else
                <a href="{{url('/subscribe/'.$user->id)}}" class="btn btn-outline btn-success mb-2" >Subscribe</a>
                @endif
                @else
                <button class="btn btn-outline btn-success mb-2" data-bs-toggle="modal" data-bs-target="#formModal">Subscribe</button>
                @endif
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="formModalLabel">Subscribe and get updates regarding podcasts of {{$user->name}}.</h4>
            ...
            <div class="modal-body">
                <input type="hidden" name="user_id" id="user_id" value="{{$user->id}}">
                    ...
                    <div class="form-group row align-items-center d-none" id="code_section">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="code" class="form-control" placeholder="6 letter code..."/>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary d-none" onclick="verifyCode()" id="verify_code_button">Verify Code</button>
                </div>
            </form>
        </div>
    </div>
