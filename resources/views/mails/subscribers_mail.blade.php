...
<body style="font-family: Nunito, sans-serif; font-size: 15px; font-weight: 400;">
    <div style="margin-top: 50px;">
        <table cellpadding="0" cellspacing="0"
            ...
            <thead>
                <tr
                    style="padding: 3px 0; line-height: 68px; text-align: center; color: #fff; font-size: 24px; font-weight: 700; letter-spacing: 1px;background-color:black;">
                    <th scope="col"><img src="{{asset('/project_images/images/'.$logo)}}"
            ...
            <tbody>
                <tr>
                    <td style="padding: 15px 24px 15px; color: black !important;">
                        Hi,
                        <br>
                        We hope this email find you in your best health and peace. The purpose of this email is to update you about the podcasts of <strong>{{$name}}</strong>.<br>
                        A new podcast has been premiered by <strong>{{$name}}</strong> whose title is "{{$title}}". So, to view this podcast please visit <strong>{{$site_title}}</strong>. 
                    </td>
                </tr>
                <tr>
                    <td style="padding: 15px 24px 15px; color: black !important;">
                        Please click <strong><a href="{{url('/'.$username)}}">here</a> to view podcast.</strong>.
                    </td>
                </tr>
