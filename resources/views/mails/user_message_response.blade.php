            ...
            <tbody>
                ...
                <tr>
                    <td style="padding: 15px 24px 15px; color: black !important;">
                        Hi {{$name}},
                        <br>
                        I have received your message regarding <strong>"{{$subject}}"</strong>.<br>
                        {{$reply}}
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding: 15px 24px 15px; color: black !important;">
                        Please click <strong><a href="{{url('/'.$user_username)}}">here</a> to view podcasts of {{$user_name}}.</strong>.
                    </td>
                </tr>
