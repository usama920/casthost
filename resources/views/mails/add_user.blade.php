            ...
            <tbody>
                ...
                <tr>
                    <td style="padding: 15px 24px 15px; color: black !important;">
                        Hi {{$name}},
                        <br>
                        We hope this email find you in your best health and peace. The purpose of this email is to welcome you on board with us at {{$site_title}}. Below you account credentials are mentioned, please don't share this email with anyone and use these credentials to login to your dashboard at {{$site_title}}.<br>
                ...
                <tr>
                    <td style="padding: 15px 24px 15px; color: black !important;">
                        Please click <strong><a href="{{url('/login')}}">here</a> to login.</strong>.
                    </td>
                </tr>
