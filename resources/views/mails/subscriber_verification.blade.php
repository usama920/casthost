            ...
            <tbody>
                ...
                <tr>
                    <td style="padding: 15px 24px 15px; color: black !important;">
                        Hi,
                        <br>
                        We hope this email find you in your best health and peace. The purpose of this email is that we have received your request regarding subscription to podcasts of casthost. Below your code for subscription verification is mentioned, please don't share this email with anyone and use these credentials to verify that this email belongs to you.<br>
