                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{url('/users/messages/detail/'.$message->id)}}">Message Detail</a>
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <section id="multiple-column-form">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="form" action="{{url('/users/message/reply')}}" method="POST">
                                    @csrf
