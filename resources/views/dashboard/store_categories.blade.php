                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{url('/users/store/categories')}}">Store Categories</a>
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <section id="basic-horizontal-layouts">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{url('/users/store/category/inactive/'.$category->id)}}"><span class="badge rounded-pill badge-light-primary">Active</span></a>
                                                @elseif ($category->status == 0)
                                                <a href="{{url('/users/store/category/active/'.$category->id)}}"><span class="badge rounded-pill badge-light-secondary">Inactive</span></a>
                                                @endif
                                            </td>
                                            <td class="text-center">
                                                ...
                                                <a href="{{url('/users/store/category/delete/'.$category->id)}}">
                ...
                <div class="modal modal-slide-in fade" id="modals-slide-in" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog sidebar-sm">
                        <form class="add-new-record modal-content pt-0" method="POST" action="{{url('/users/store/category/add')}}">
                            @csrf
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="add-new-record modal-content pt-0" method="POST" action="{{url('/users/store/category/edit')}}">
