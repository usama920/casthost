                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a
                                            href="{{ url('/users/store/product/detail/' . $product->id) }}">Podcast
                                            Detail</a>
                                    </li>
                                </ol>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form form-horizontal" method="POST"
                                    action="{{ url('/users/store/product/update') }}" enctype="multipart/form-data">
                                    @csrf
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <a href="{{url('/users/store/product/other_image/delete/'.$image->id)}}">Delete</a>
                                                                                </td>
                                                                            </tr>
                                                                            @endforeach
                                                                        </tbody>
