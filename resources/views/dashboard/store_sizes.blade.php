                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{url('/users/store/sizes')}}">Store Sizes</a>
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <section id="basic-horizontal-layouts">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if($size->status == 1)
                                                <a href="{{url('/users/store/size/inactive/'.$size->id)}}"><span class="badge rounded-pill badge-light-primary">Active</span></a>
                                                @elseif ($size->status == 0)
                                                <a href="{{url('/users/store/size/active/'.$size->id)}}"><span class="badge rounded-pill badge-light-secondary">Inactive</span></a>
                                                @endif
                                            </td>
                                            <td class="text-center">
                                                ...
                                                <a href="{{url('/users/store/size/delete/'.$size->id)}}">
                ...
                <div class="modal modal-slide-in fade" id="modals-slide-in" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog sidebar-sm">
                        <form class="add-new-record modal-content pt-0" method="POST" action="{{url('/users/store/size/add')}}">
                            @csrf
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="add-new-record modal-content pt-0" method="POST" action="{{url('/users/store/size/edit')}}">
